            ...
            <div className="flex flex-col-reverse flex-wrap md:flex-row px-4">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <a className="px-3 py-2 border border-neutral-800 rounded-md self-start bg-gradient-to-l from-gray-300 to-gray-500 text-neutral-800" href="/MILKIYAS_GEBRU_2026_CV.pdf" download="MILKIYAS_GEBRU_CV.pdf">Download Resume</a>
                    </div>
                </div>
